...
const TEST_CASES = [
  {
    label: '케이스 1 — LG생활건강 브랜드 마케터',
    company: 'LG생활건강',
    role: '브랜드 마케터',
    level: '중급',
    audience: '마케팅 경력 3~5년, AI 경험 적음',
    topicCode: 'N1',
    topicName: '생성형 AI 업무 활용 기초',
    moduleId: 'N1-M03',
  },
  {
    label: '케이스 2 — 크래프톤 게임 기획자',
    company: '크래프톤',
    role: '게임 기획자',
    level: '중급',
  ...
  {
    label: '케이스 3 — 한국타이어앤테크놀로지 마케팅 담당자',
    company: '한국타이어앤테크놀로지',
    role: '마케팅 담당자',
    level: '중급',
    audience: '마케팅 경력 3년, AI 초보',
    topicCode: 'N1',
    topicName: '생성형 AI 업무 활용 기초',
    moduleId: 'N1-M03',
  },
  {
    label: '케이스 4 — BGF리테일 상품기획 담당자',
    company: 'BGF리테일',
    role: '상품기획 담당자',
    level: '입문',
    audience: 'MD 경력 5년, AI 처음 접함',
    topicCode: 'N1',
    topicName: '생성형 AI 업무 활용 기초',
    moduleId: 'N1-M03',
  },
  {
    label: '케이스 5 — F&F 디자인팀',
    company: 'F&F',
    role: '패션 디자이너',
    level: '중급',
    audience: '디자인 경력 3~5년, AI 툴 일부 경험',
    topicCode: 'N1',
    topicName: '생성형 AI 업무 활용 기초',
    moduleId: 'N1-M03',
  },
...
- 주요 브랜드명·제품명 (예: LG생활건강의 "후·오휘·숨37°·페리오·엘라스틴", 크래프톤의 "PUBG·배틀그라운드·뉴스테이트")
- 공개된 제품 카테고리·사업 영역 (예: BGF리테일의 "CU 편의점", F&F의 "MLB·Discovery Expedition·스트레치엔젤스", 한국타이어의 "한국타이어·라우펜")
...
[요청]
위 모듈의 학습 내용을 ${tc.company} ${tc.role} 직무 맥락으로 재작성해주세요.
